...
export class TodosPageComponent implements OnInit, OnDestroy {
  ...
  newTodoControlName = new FormControl('', {
    nonNullable: true,
    validators: [Validators.required, Validators.minLength(3)]
  });

  newTodoControlDescription = new FormControl('', {
    nonNullable: true,
    validators: [Validators.required, Validators.minLength(3)]
  });
  ...
  constructor(private todosFacade: TodosFacadeService, public router: Router, private activatedRoute: ActivatedRoute) {}
  ...
  createTodo() {
    this.todosFacade.addTodo({
      ...
      id: v4(),
      title: this.newTodoControlName.value,
      isCompleted: false,
      isFavorited: false,
      description: this.newTodoControlDescription.value
    })
      .subscribe({
